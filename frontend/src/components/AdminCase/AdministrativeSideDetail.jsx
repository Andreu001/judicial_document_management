...
const AdministrativeSideDetail = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const rolesResponse = await AdministrativeCaseService.getSideRoles();
        ...
        if (sideId && sideId !== 'create' && sideId !== 'undefined' && sideId !== 'null') {
          const data = await AdministrativeCaseService.getSideById(proceedingId, sideId);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Sending nested data:', adminSideData);

      if (sideId && sideId !== 'create' && sideId !== 'undefined' && sideId !== 'null') {
        await AdministrativeCaseService.updateSide(proceedingId, sideId, adminSideData);
      } else {
        await AdministrativeCaseService.createSide(proceedingId, adminSideData);
      }
...
export default AdministrativeSideDetail;