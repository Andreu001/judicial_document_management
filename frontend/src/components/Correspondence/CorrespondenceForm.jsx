...
const CorrespondenceForm = ({ initialData = {}, mode = 'create' }) => {
  ...
  const getCorrespondenceType = () => {
    ...
    if (location.state?.correspondenceType) {
      return location.state.correspondenceType;
    }
  ...
  const getFormTitle = () => {
    const action = mode === 'edit' ? 'Редактирование' : 'Регистрация';
    const typeText = correspondenceType === 'incoming' ? 'входящей' : 'исходящей';
    return `${action} ${typeText} корреспонденции`;
  };
            ...
            <div className={styles.formSection}>
              ...
              {correspondenceType === 'incoming' && (
                <div className={styles.formRow}>
                  <div className={styles.formGroup}>
                    <label htmlFor="number_sender_document">Исх. номер документа отправителя</label>
                    <input
                  ...
                  <div className={styles.formGroup}>
                    <label htmlFor="outgoing_date_document">Исх. дата документа отправителя</label>
                    <input
