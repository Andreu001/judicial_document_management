...
urlpatterns = [
    ...
    path('correspondence/statistics/', views.CorrespondenceViewSet.as_view({'get': 'statistics'}), name='correspondence-statistics'),
    path('search-cases/', search_views.CaseSearchView.as_view(), name='search-cases'),  # Изменено название
]