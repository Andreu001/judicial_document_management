...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=150, null=True, verbose_name='ФИО / Наименование')),
                ('status', models.CharField(blank=True, choices=[('individual', 'Физическое лицо'), ('legal', 'Юридическое лицо'), ('government', 'Орган власти'), ('other', 'Иное')], default='individual', max_length=20, null=True, verbose_name='Статус лица')),
