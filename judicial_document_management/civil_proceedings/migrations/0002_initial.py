...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='civilproceedings',
            name='case_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='civil_proceedings.civilproceedingstype', verbose_name='Вид производства'),
        ),
        migrations.AddField(
