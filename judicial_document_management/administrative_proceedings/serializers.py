...
class KasSidesCaseInCaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'kas_proceedings', 'sides_case_incase', 'sides_case_role',
...
class KasLawyerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KasLawyer
        fields = [
            'id', 'kas_proceedings', 'lawyer', 'sides_case_role',
            'lawyer_detail', 'sides_case_role_detail',
            'lawyer_data', 'existing_lawyer_id'
        ]
        read_only_fields = ('kas_proceedings', 'lawyer')
...
class KasPetitionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KasPetition
        fields = [
            'id', 'kas_proceedings', 'petitions_incase',
        ...
        read_only_fields = ('kas_proceedings', 'petitions_incase')
...
class KasProceedingsSerializer(serializers.ModelSerializer):
    ...
    def validate_case_number_kas(self, value):
        ...
        if instance and instance.case_number_kas == value:
            return value
        if KasProceedings.objects.filter(case_number_kas=value).exists():
