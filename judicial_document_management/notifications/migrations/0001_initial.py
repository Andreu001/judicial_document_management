    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('jurisdiction_check', 'Проверка подсудности'), ('deadline_warning', 'Предупреждение о сроке'), ('required_action', 'Обязательное действие'), ('status_change', 'Изменение статуса'), ('incoming_correspondence', 'Входящая корреспонденция'), ('outgoing_correspondence', 'Исходящая корреспонденция')], default='status_change', max_length=50, verbose_name='Тип уведомления')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rule_type', models.CharField(choices=[('jurisdiction_check', 'Проверка подсудности'), ('deadline_warning', 'Предупреждение о сроке'), ('required_action', 'Обязательное действие'), ('status_change', 'Изменение статуса'), ('incoming_correspondence', 'Входящая корреспонденция'), ('outgoing_correspondence', 'Исходящая корреспонденция')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('criminal_proceeding', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='criminal_proceedings.criminalproceedings', verbose_name='Уголовное дело')),
            ],
            options={
